...
MODEL_SAVE='./logs/models/model_1549957971_59.pkl'
...
if __name__=='__main__':
    ...
    for i in image_files:
        ...
        cluster=lane_cluster(1.5,img,embedding.squeeze().data.cpu().numpy(),threshold_mask)
        instance_mask,labels=cluster()
